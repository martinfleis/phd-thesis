...
The first distinction can be made based on the number of dimensions to *unidimensional* and *multidimensional*. Dimensions can be both numerical and categorical variables, where unidimensional numerical classification is also known as *binning*. The scope of this work is in multidimensional classification as a single dimension does not have the explanatory power to describe the complexity of urban form.
