...
Consider an illustrative example below, of a small town in Czechia. The whole fabric of the town is composed of few SAs. The working hypothesis @dibble2017 use is that it is composed of several classes of urban patterns as shown on figure \ref{fig:mile_tissue}\footnote{The identification of homogenous areas is purely perceptional, based on the personal knowledge of the place and visual interpretation of build form patterns. The map is for an illustrative purpose only.}.
