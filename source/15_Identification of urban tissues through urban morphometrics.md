...
![normals](source/figures/ch7/kdeplots.pdf "Short caption"){#fig:sscCCo_kdeplot width=100%}
...
### Contextual characters
*illustration of contextual characters esp. in relation to primary ones*
- Few examples, rest in Appendix?
- Use the same examples as in Primary so illustrate smoothing
