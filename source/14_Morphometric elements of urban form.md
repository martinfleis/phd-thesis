...
On the other hand, morphological tessellation cannot fully substitute plot. The similarity of information indicates only partial overlap, and there are aspects of form which cannot be derived from morphological tessellation conceptually as a relationship between public and private or ownership-based analysis. That said, morphological tessellation has the potential to work as an analytical spatial unit within the morphometric assessment, acknowledging that the information obtained from morphological tessellation is not equal to that derived from plots (no matter the definition).
