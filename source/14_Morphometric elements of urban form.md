...
The results suggest that the proposed method contributes to resolving some of the limitations associated with using the plot as a unit of UMM analysis. However, the picture resulting from testing the similarity between cadastral plots and MCs is rather complex. 
